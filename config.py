...
HISTORY_MIN_FRESH_COVERAGE = float(os.getenv("HISTORY_MIN_FRESH_COVERAGE", "0.80"))
HISTORY_COVERAGE_MIN_USERS = int(os.getenv("HISTORY_COVERAGE_MIN_USERS", "100"))
HISTORY_SNAPSHOT_RETRY_SECONDS = int(os.getenv("HISTORY_SNAPSHOT_RETRY_SECONDS", "600"))
HISTORY_EXACT_COUNT_MIN_BASELINE_AGE_MINUTES = float(
    os.getenv("HISTORY_EXACT_COUNT_MIN_BASELINE_AGE_MINUTES", "15")
)
HISTORY_EXACT_COUNT_MAX_CANDIDATES = int(
    os.getenv("HISTORY_EXACT_COUNT_MAX_CANDIDATES", "40")
)
